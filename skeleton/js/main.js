...
//run timer for part 2: training powers = 30s
    var myTimer = setTimeout(one, 5000);


//PART 2: ACTIVATE SPECIAL POWERS
    ...
    var myTimer = setTimeout(two, 30000);
...
//run timer for part 3: using powers = 1 minute but maybe should not be a timer
        var myTimer = setTimeout(three, 30000);
