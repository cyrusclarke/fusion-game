...
img.filename = '/circle-blob-1.png';
...
// var bridge2 = document.getElementById("image-2"),
// bridge2Canvas = bridge2.getContext('2d');
// (function(){

//   // get the canvas, 2d context, paragraph for data and set the radius
//   var canvas2 = document.getElementById("image-2"),
//   // document.getElementsByTagName('canvas')[0],
...
//   // ctx.fillStyle = "rgba(0,0,0,0.9)";
//   ctx2.strokeStyle = "rgba(255,0,0,0.9)";
//   ctx2.lineWidth = 5;
...
// // var bridge = document.getElementById("bridge"),
// // bridgeCanvas = bridge.getContext('2d'),
// var brushRadius = (bridge2.width / 100) * 5,
// img = new Image();
...
// }
// img.loc = '../img';
// img.filename = '/circle-blob-2.png';
// // if (window.devicePixelRatio >= 2) {
// //   var nameParts = img.filename.split('.');
// //   img.src = img.loc + nameParts[0]+"-2x"+"."+nameParts[1];
// // } else {
//   img.src = 'https://dea.rs/Fusion_test/fusion_game/skeleton/img/circle-blob-2.png';
// // }
